module.exports = {
  WELCOME_VERIFICATION_EMAIL: `<p>Hello<span style="color: #3366ff;"> <strong>{{username}}
    </strong></span>,</p><p>Verify your account for ChicMic by clicking on the below link<span style="color: #3366ff;"><strong></p><a href={{verifylink}} target="_blank">Verify My Account</a><p>Regards,<br>
    Team ChicMic </p>`,
